// extra null element after each sentence.
var wordbyword = ["Cherish","every", "moment!",,
"The", "best", "time", "for", "new", "beginnings", "is", "now.",,
"All", "you", "need", "in", "this", "life", "is", "ignorance", "and", "confidence,", "and", "then", "success", "is", "sure.",,
"The", "secret", "of", "getting", "ahead", "is", "getting", "started.",,
"Wrinkles", "should", "merely", "indicate", "where", "smiles", "have", "been.",,
"Sometimes,", "it", "takes", "a", "good", "fll", "to", "really", "know", "where", "we", "stand.",,
...
window.onload = function() {
    ...
    var seconds = 15;
    var timecopy = seconds;
    var wpm;
    var accuracy;
    // setInterval calls the function inside every miliisecond, 
    // until clearInterval() is called. 
    // multiplied by thousand to get it in seconds
    var Timer = setInterval(function(){
        ...
        if(seconds == -1) {
            ...
            // if no input received, accuracy results in NaN by zero divison
            if(Number.isNaN(accuracy)) {
                accuracy = 0;
            }
            // customized alert plugin
            swal({
...
$(window).keypress(
    function(event) {
    // if input is space, which indicates the end of a word
    // spelling is checked for that word
